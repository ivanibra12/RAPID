...
public class UpdateSecurityProfessionalActivity extends AppCompatActivity {
    ...
    {
        emailInputLayout.getEditText().setText(ProfessionalMainActivity.loggedInUser.getEmail());
    }
    ...
    public void onBackPressed() {
        ...
        //override and go to settings professional activity
        finish();
        startActivity(new Intent(UpdateSecurityProfessionalActivity.this,SettingsProfessionalActivity.class));
    }
    /**********************************************************************************************/
}
