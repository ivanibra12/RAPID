...
public class JobServiceDetailsActivity extends AppCompatActivity {
    ...
    private void reportProfessional()
    {
        Intent intent = new Intent(JobServiceDetailsActivity.this,ReportActivity.class);
    ...
    private void loadDetails()
    {
        ...
        firstnameTextView.setText("First name : "+jobSelected.getResponse().getProfessional().getFirstName());
        lastnameTextView.setText("Last name : "+jobSelected.getResponse().getProfessional().getLastName());
        mobileNumberTextView.setText("Mobile number : "+jobSelected.getResponse().getProfessional().getMobileNo());
    ...
    public void onBackPressed() {
        ...
        finish();
        startActivity(new Intent(JobServiceDetailsActivity.this,JobHistoryActivity.class));
    }
    /**********************************************************************************************/
}
